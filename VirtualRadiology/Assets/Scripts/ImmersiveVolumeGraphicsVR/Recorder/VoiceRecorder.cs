...
namespace ImmersiveVolumeGraphics
{
    ...
    namespace Recorder
    {
        public class VoiceRecorder: MonoBehaviour
        {
            ...
            /// <summary>
            /// Information hint for the user in VR
            /// </summary
            ...
            /// <li>Stop the keyword listener</li>
            ...
            private void OnKeywordsRecognized(PhraseRecognizedEventArgs args)
            {
                ...
                if (MainMenu.Status == 4)
                {
                    if (args.text == "record")
                    {
                        //Changes the text to "Recording" in the color red to signalize that the recording has started
            ...
            /// <summary>
            /// This method is triggered when the dictation is complete
            /// </summary>
            /// <remarks>
            /// <ul>
