...
namespace ImmersiveVolumeGraphics {
    ...
    namespace ModelImport
    {
        ...
        {
            /// <summary>
            /// Array of all meta information eg. patient´s name , modality etc.
            ...
            /// <li>Set the pixelSpacingX, pixelSpacingY , sliceThickness to 0 and MetaInformationText to empty
            /// (for resetting when a new Model will be loaded) </li>
            /// <li>Check if the text file exists</li>
            /// <li>Create a new StreamReader that reads the Data</li>
            /// <li>The datas tructure for the metaInformation-Array which stores the data looks like this: </li>
            /// </ul>
            /// <table>
            /// <tr>
            ...
            public static void ReadDICOMMetaInformation()
            {
                ...
                MetaInformationText.text = string.Empty;
